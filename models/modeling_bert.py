...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        pooled_output, first_token_tensor = self.pooler(sequence_output) if self.pooler is not None else None
...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def forward(
        ...
        output_hidden_states=None,
        return_dict=None,
        return_first_token_tensor=False,
        ...
        outputs, first_token_tensor = self.bert(
            input_ids,
            attention_mask=attention_mask,
            token_type_ids=token_type_ids,
            position_ids=position_ids,
